...
public class UploadEventServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Date date = new Date();
		String savePath = appPath + SAVE_DIR + File.separator + "event-" + dateFormat.format(date);
...
//		String path = appPath + SAVE_DIR + File.separator + "event-" + dateFormat.format(date) + File.separator + fileName;
...
//		System.out.println("path 0" + path);
		request.setAttribute("path", SAVE_DIR + File.separator + "event-" + dateFormat.format(date) + File.separator + fileName);
